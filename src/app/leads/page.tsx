                ...
                <tr key={lead.id} className="table-row">
                  ...
                  <td className="px-3 py-3 text-right">
                    <div className="flex items-center justify-end gap-0.5">
                      {lead.phone && <button onClick={() => { setMsgLead(lead); setMsgChannel('whatsapp'); setMsgOpen(true); }} className="p-1.5 rounded hover:bg-green-500/20 text-prospex-dim hover:text-green-400 transition-colors" title="WhatsApp"><MessageCircle className="w-3.5 h-3.5" /></button>}
